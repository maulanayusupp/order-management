...
<html lang="en">
  <head>
    ...
    <title>@yield('title') | Ordering Management System</title>
      ...
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{ url('home') }}" class="site_title">
                ...
                <span>INSTAPP<font color="red">.ID</font></span>
              </a>
            </div>
            ...
            <!-- /menu footer buttons -->
            @include('layouts.includes.footer-menu')
            <!-- /menu footer buttons -->
          </div>
        </div>
        ...
        <footer>
          <div class="pull-right">
            Instapp.id - Multi-platform Mobile Application
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
